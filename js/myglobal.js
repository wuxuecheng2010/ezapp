var VERSION = "1.4.0"; //版本号  每次升级前修改一次  数据库中保存的版本号 加一行，与之对应；
var VID = "43"; //版本号  每次升级前修改一次  数据库中保存的版本号 加一行，与之对应；
var DEBUG=false;//   true-为开发模式  false-为正式模式

var TIP = "192.168.1.105:85";
var NIP = "192.168.0.117";
var WIP = "122.226.128.221"
...
var DATERANGER = '{"type":"date","beginYear":2017,"endYear":2020}';
